...
<div>
    ...
    <h5 class="text-center pt-5">Kellékszavatosság </h5>

    <p class="text-justify">
        (forrás: <a href="http://fogyasztovedelem.kormany.hu" target="_blank">http://fogyasztovedelem.kormany.hu</a>)
    </p>
    <p class="text-justify">
    ...
    <h5 class="text-center pt-5">Online vitarendezés</h5>

    <p class="text-justify">
        Online fogyasztói jogviták pártatlan, hatékony és bíróságon kívüli rendezése﻿ az alábbi linkre kattintva online módon rendezhető: <a href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home.show&lng=HU" target="_blank">LINK</a>
    </p>
    ...
    <h5 class="text-center pt-5">Alkalmazandó jog, illetékesség és választott bíráskodás</h5>

    <p>bla-bla</p>
    <h5 class="text-center pt-5">Elállási, visszatartási és felmondási jog</h5>
    <p class="text-justify">
        (forrás: <a href="http://magyarefk.hu/hu/hasznos-tudnivalok/internetes-vasarlas/elallasi-jog.html﻿" target="_blank">LINK﻿)</a>
    </p>
    ...
    <h5 class="text-center pt-5">Elállási jog gyakorlásának menete</h5>
    ...
    <p class="text-justify">
        A termék visszaérkezését követő harminc napon belül a ... Kft. a vásárló által megadott bankszámla számra visszatéríti a termék vételárát.
    </p>
    ...
    <h5 class="text-center pt-5">Panasz esetén</h5>

    <p class="text-justify">
        Az Ügyfél, a ... Kft. által nyújtott szolgáltatással kapcsolatosan bármikor panasszal élhet. A panaszát az Ügyfélszolgálat elérhetőségein juttathatja el a ... Kft. számára.
    </p>
    ...
    <p class="text-justify">
        A panaszokat a ... Kft. minden esetben elbírálja és megteszi a szükséges lépéseket a panaszok kezelésére. A panaszok beérkezéstől számított 14 munkanapon belül elbírálásra és orvoslásra kerülnek.
    </p>

    <p class="text-justify">
        Az Ügyfél által bejelentett panaszokat a beérkezés módjától függően a ... Kft. a vizsgálat eredményéről értesítést küld.
    </p>
</div>
