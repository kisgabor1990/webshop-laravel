...
@section('content')
    ...
    <h1 class="user-select-none mb-5 text-center">Új vásárló regisztrálása</h1>
    ...
    <form class="needs-validation" action="{{ url('/megrendeles/regisztracio') }}" method="post" novalidate>
        @csrf
