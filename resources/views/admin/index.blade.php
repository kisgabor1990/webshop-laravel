        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link {{ request()->is('admin/felhasznalok') ? 'active' : '' }}" aria-current="page"
                        href="{{ url('admin/felhasznalok') }}"><i class="fa fa-user fa-lg fa-fw"
                            aria-hidden="true"></i> Felhasználók</a>
                    <a class="nav-link {{ request()->is('admin/kategoriak') ? 'active' : '' }}" aria-current="page"
                        href="{{ url('admin/kategoriak') }}"><i class="fa fa-tags fa-lg fa-fw" aria-hidden="true"></i>
                        Kategóriák</a>
                    <a class="nav-link {{ request()->is('admin/termekek') ? 'active' : '' }}" aria-current="page"
                        href="{{ url('admin/termekek') }}"><i class="fas fa-store fa-lg fa-fw" aria-hidden="true"></i>
                        Termékek</a>
                    <a class="nav-link {{ request()->is('admin/rendelesek') ? 'active' : '' }}" aria-current="page"
                        href="{{ url('admin/rendelesek') }}"><i class="fas fa-clipboard-list fa-lg fa-fw"></i>
                        Rendelések</a>
